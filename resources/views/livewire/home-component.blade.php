<main id="main">
    <div class="container">
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="{{ asset('') }}asimages/digital-electronic-banner.jpgsets/" width="1170" height="240" alt=""></figure>
                </a>
            </div>
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="{{ asset('') }}asimages/fashion-accesories-banner.jpgsets/" width="1170" height="240" alt=""></figure>
                </a>
            </div>
            <div class="wrap-products">
                <div class="wrap-product-tab tab-style-1">
